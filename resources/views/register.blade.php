<x-layout title="Регистрация">
    <div class="max-w-md mx-auto">
        <div class="text-xl font-medium mb-6">Регистрация</div>
        ...
        <div class="bg-white border border-gray-300 p-6">
            <form action="{{ route('register') }}" method="post" class="space-y-4">
                ...
                <div>
                    <div class="text-sm mb-1">ФИО</div>
                    <input type="text" name="fio" class="w-full border border-gray-300 px-3 py-2" required>
                    @error('fio')
            ...
            <div class="mt-4 pt-4 border-t border-gray-200 text-center">
                <a href="{{ route('loginIndex') }}" class="text-sm underline">Уже есть аккаунт</a>
            </div>
        </div>
    </div>
</x-layout>